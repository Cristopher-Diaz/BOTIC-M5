...
<title>Horóscopo Chino - Edición de usuario</title>
<!-- Bootstrap CSS -->
<link
		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="text-center mb-4">
					<h1 class="h3">Edición de usuario</h1>
					<p>Actualice la información de su usuario.</p>
				</div>
					...
					<form action="EditUser" method="post">
						...
						<div class="mb-3">
							<label for="name" class="form-label">Nombre</label> <input
								...
								value="${userData.nombre}" placeholder="Ingrese su nombre"
								required>
						</div>
